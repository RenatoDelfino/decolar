...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 bg-white p-3 rounded-xl",
        month: "space-y-4",
        ...
        day_selected:
          "border-[#550fed] border hover:border-[#550fed] focus:border-[#550fed] dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_outside:
